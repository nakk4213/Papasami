...
export default async function DesignerDashboardPage() {
  ...
  return (
    <DashboardShell role="DESIGNER">
      <StatGrid stats={[{ label: "Assigned projects", value: assigned }, { label: "Earnings", value: formatCurrency(8200).replace(".00", "") }, { label: "Rating", value: "4.9" }, { label: "Availability", value: "Online" }]} />
